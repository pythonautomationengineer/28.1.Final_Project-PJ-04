...
* fake_person.py - генерация необходимых тестовых данных: имени, фамилии, отчества и телефона
...
#### Версия драйвера и его установка 
...
Это нормально, нужно просто перезапустить тесты после скачивания последней версии драйвера.
